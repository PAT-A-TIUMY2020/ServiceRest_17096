...
namespace ServiceRest_17096_HafizhPratama
{
	...
	public class TI_UMY : ITI_UMY
	{
		...
		{
			string msg = "GAGAL";
			SqlConnection sqlcon = new SqlConnection("Data Source=DESKTOP-3OJ10LD;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa;Password=123");
